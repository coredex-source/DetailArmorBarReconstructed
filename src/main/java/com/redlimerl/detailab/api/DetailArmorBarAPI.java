...
public class DetailArmorBarAPI {
    ...
    static HashMap<Item, CustomArmorBar> staticArmorList = new HashMap<>();
    static HashMap<Item, CustomArmorBar> staticItemList = new HashMap<>();

    public static Map<Item, CustomArmorBar> getArmorBarList() {
    ...
    public static Map<Item, CustomArmorBar> getStaticArmorBarList() {
