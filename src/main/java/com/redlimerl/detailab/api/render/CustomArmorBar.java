...
public class CustomArmorBar {
    ...
    public void draw(ItemStack itemStack, GuiGraphicsExtractor context, int xPos, int yPos, boolean isHalf, boolean isMirror) {
    ...
    public void drawOutLine(ItemStack itemStack, GuiGraphicsExtractor context, int xPos, int yPos, boolean isHalf, boolean isMirror, Color color) {
        BarRenderManager renderInfo = predicate.apply(itemStack);
        if (renderInfo.isHidden()) return;
